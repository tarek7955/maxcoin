                                        ...
                                        if(strpos($service_type, 'qty') !== false){
                                            ...
                                            <div class="col-sm-3 col-xs-9">
                                                <div class="input-group input-group-sm">
                                                    ...
                                                    <input class="form-control input-number sendAjaxForm" type="text" max="200" min="1" value="<?php echo $qty; ?>" name="qty_service_<?php echo $id_service; ?>" data-action="<?php echo getFromTemplate('common/update_booking.php'); ?>" data-target="#total_booking">
                                                    <span class="input-group-btn">
