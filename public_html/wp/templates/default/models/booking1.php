...
$query_room = 'SELECT * FROM pm_room WHERE checked = 1 AND cat = 0 AND lang = '.LANG_ID.' ORDER BY';
...
<section id="page">
    ...
    <div id="content" class="pt30 pb30">
        ...
        <div id="search-page" class="mb20">
            <div class="container">
                <?php include(getFromTemplate('common/searchp.php', false)); ?>
            </div>
        ...
        <form action="/wp/party-booking" method="post" class="ajax-form">
                        ...
                        <div class="booking-result">
                            <div class="row">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-3 text-center sep">
                                    ...
                                    <div class="mb10 text-muted"><?php echo $texts['PRICE']; ?> / <?php echo $type; ?>or Day</div>
                                    <?php echo $texts['CAPACITY']; ?> : <i class="fas fa-fw fa-male"></i>x<?php echo $max_people; ?>
                                    
                                    <?php
                                    if($room_stock > 0){ ?>
                                        <div class="input-group input-group-sm mt10">
                                            <div class="input-group-addon"><i class="fas fa-fw fa-tags"></i><p class="badge badge-primary"> Book?</p></div>
