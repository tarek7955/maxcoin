...
$query_room = 'SELECT * FROM pm_room WHERE checked = 1 AND cat = 1 AND lang = '.LANG_ID.' ORDER BY';
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-3 text-center sep">
                                    ...
                                    if($room_stock > 0){ ?>
                                        <div class="input-group input-group-sm mt10">
                                            <div class="input-group-addon"><i class="fas fa-fw fa-tags"></i><p class="badge badge-primary"> Select rooms</p></div>
